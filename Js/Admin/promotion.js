document.addEventListener("DOMContentLoaded", () => {
  ...
  // Initialize PromotionFilterManager
  if (document.getElementById("promotionFilterForm")) {
    window.promotionFilterManager = new PromotionFilterManager();
  }
});

// ========== MODERN PROMOTION FILTER MANAGER ==========
class PromotionFilterManager {
  constructor() {
    this.form = document.getElementById("promotionFilterForm");
  ...
  init() {
    ...
    const isCollapsed =
      localStorage.getItem("promotionFilterCollapsed") === "true";
    if (isCollapsed) {
  ...
  toggleFilterPanel() {
    ...
    localStorage.setItem("promotionFilterCollapsed", isCollapsed);
  }
  ...
  updateActiveFilters() {
    ...
    container.innerHTML = filters
      .map(
        ...
        <span class="remove-chip" onclick="promotionFilterManager.removeFilter('${filter.key}')">&times;</span>
      </div>`
      )
      .join("");
  }
